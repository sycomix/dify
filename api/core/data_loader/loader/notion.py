...
class NotionLoader(BaseLoader):
    ...
    def load(self) -> List[Document]:
        ...
        return self._load_data_as_documents(
    ...
    def _load_data_as_documents(
        ...
        if notion_page_type == 'database':
            ...
            docs.extend(Document(page_content=page_text) for page_text in page_text_list)
        else:
    ...
    def _get_notion_database_data(
        ...
        res = requests.post(
            ...
            headers={
                "Authorization": f"Bearer {self._notion_access_token}",
        ...
        for result in data["results"]:
            ...
            for key, value in row_dict.items():
                if isinstance(value, dict):
                    ...
                    row_content = f'{row_content}{key}:{value_content}\n'
                else:
                    row_content = f'{row_content}{key}:{value}\n'
    ...
    def _get_access_token(cls, tenant_id: str, notion_workspace_id: str) -> str:
        if data_source_binding := DataSourceBinding.query.filter(
            db.and_(
                ...
                DataSourceBinding.source_info['workspace_id']
